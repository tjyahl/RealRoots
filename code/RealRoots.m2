...
document {
	...
	PARA{"This computes the k x k submatrix ",TEX///$H_{k}$///," of the corresponding leading principal minor of the Hurwitz matrix ",TEX///$H$///," of a rational univariate polynomial ", TT "f"," with positive leading coefficient and degree at least 1.
...
document {
	...
	Headline => "the leading principal minor of the Hurwitz matrix H of a rational univariate polynomial, after removing the last n-k rows and n-k columns of H",
	Usage => "HurwitzDeterminant(f,k)",
	Inputs => {
	    RingElement => "f" => {"a rational univariate polynomial"},
	    ZZ => "k" => {"a nonnegative integer that determines the dimensions of a square submatrix of the Hurwitz matrix of ",TT "f","."},
	    },
	Outputs => { RR => {"the leading principal minor of the Hurwitz matrix ",TEX///$H$///," of a rational univariate polynomial ", TT "f", " after removing the last ",TEX///$n-k$///," rows and ",TEX///$n-k$///," columns of ",TEX///$H$///}},

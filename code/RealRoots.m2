...
document {
	...
	Headline => "the ",TEX///$k\times k$," submatrix generated by the corresponding leading principal minor of the ",TEX///$n\times n$///," Hurwitz matrix H of a rational univariate polynomial of degree n",

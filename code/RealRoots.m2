...
document {
	...
	PARA {"This computes the number of distinct real points of Spec ", TT "S", ", not counting multiplicity.
	       ...
	       where ",TT "R"," is the ring generated by the variables that appear in ",TT "f"," (resp. in ",TT "I","). If ", TT "l", " is a system of rational polynomials, then this computes its number of real solutions, not counting multiplicity."},
    	PARA {"This counts the number of real roots of a univariate polynomial ",TT "f",", not counting multiplicity."},
	EXAMPLE lines ///
 	         R = QQ[x,y]
		 f = (x^2 + 1)*(x + 1)*(x - 2)^2
		 realCount(f)

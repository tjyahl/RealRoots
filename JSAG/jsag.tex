...
\begin{proof}
  ...
  The proof considers $\var(\Syl(f,g), a)-\var(\Syl(f,g), c)$ for $c\in(a,b\hspace{.05cm}]$, noting that this quantity may only change when
  $c$ passes a root of some member of the Sylvester sequence $\Syl(f,g)$.
